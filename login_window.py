...
from database import insert_user, create_table, check_user_credentials  # Import new database function
from reset_password_window import ResetPasswordWindow
from MainUI import VirtualStudyRoomUI  # Replace the previous import
...
class MainWindow(QWidget):
    def __init__(self):
        ...
        self.setStyleSheet("background-color: #f3f1fe;")  # Use your preferred style
        self.init_ui()

    def init_ui(self):
        # Add UI components for your main window here
...
class LoginWindow(QWidget):
    ...
    def init_ui(self):
        ...
        # LEFT: Image
        left_label = QLabel()
        pixmap = QPixmap("D:/ICPC/login.jpg")  # Update the image path accordingly
    ...
    def create_login_form(self):
        ...
        """)
        login_button.clicked.connect(self.login)  # Connect login button to login method
    ...
    def login(self):
        ...
        if check_user_credentials(username, password):
            ...
            self.MainUI = VirtualStudyRoomUI()
            self.MainUI.show()
